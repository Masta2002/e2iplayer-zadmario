# -*- coding: utf-8 -*-
# Last Modified: 2026-08-18 - Multi-tap T9 like in SearchHistoryEditor - Kamikaze24
...
class E2iPlayerWidget(Screen):
    ...
    def ok_pressed(self, eventFrom='remote', useAlternativePlayer=False):
        ...
        if self.visible or 'sequencer' == eventFrom:
            ...
            if sel is None:
                ...
                elif item.type == CDisplayListItem.TYPE_SEARCH_HISTORY_EDITOR:
                    printDBG("okpressed selected TYPE_SEARCH_HISTORY_EDITOR")
                    self.stopAutoPlaySequencer()
    ...
    def selectLinksCallback(self, retArg):
        ...
        if isinstance(retArg, IPTVChoiceBoxItem) and isinstance(retArg.privateData, CUrlItem):
            ...
            videoUrl = link.url
            if isinstance(videoUrl, basestring) and len(videoUrl) > 3:
